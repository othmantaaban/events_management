    ...
    <form action="{{ route('admin.entreprises.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="secteur_activite" id="secteur_activite" value="{{ old('secteur_activite') }}" required
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
            </div>
            ...
            <div>
                ...
                <select name="taille_entreprise" id="taille_entreprise" required
                    ...
                    <option value="1-10" {{ old('taille_entreprise') == '1-10' ? 'selected' : '' }}>1-10 employés</option>
                    <option value="11-50" {{ old('taille_entreprise') == '11-50' ? 'selected' : '' }}>11-50 employés</option>
                    <option value="51-200" {{ old('taille_entreprise') == '51-200' ? 'selected' : '' }}>51-200 employés</option>
                    <option value="201-500" {{ old('taille_entreprise') == '201-500' ? 'selected' : '' }}>201-500 employés</option>
                    <option value="500+" {{ old('taille_entreprise') == '500+' ? 'selected' : '' }}>500+ employés</option>
                </select>
            </div>
