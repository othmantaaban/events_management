...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Alpine: () => (/* reexport safe */ alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"])
/* harmony export */ });
...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app', {
  ...
  darkMode: alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].$persist(true).as('darkMode'),
  // Sidebar (persistant pour desktop)
  sidebarOpen: alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].$persist(true).as('sidebarOpen'),
  // Mobile menu
  ...
  init: function init() {
    ...
    window.addEventListener('resize', function () {
      return _this.handleSidebarResponsive();
    });

    // Fermer le menu mobile lors du clic en dehors
    document.addEventListener('click', function (e) {
      if (_this.mobileMenuOpen && !e.target.closest('.sidebar') && !e.target.closest('[data-sidebar-toggle]')) {
        _this.mobileMenuOpen = false;
      }
    });
  },
  // Méthodes
  applyDarkMode: function applyDarkMode() {
  ...
  showToast: function showToast(message) {
    ...
    toast.className = "fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-4 rounded-xl shadow-2xl text-white font-medium transform translate-y-20 opacity-0 transition-all duration-300 ".concat(colors[type] || colors.info, " border-l-4");
...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].effect(function () {
  var store = alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app');
...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].data('modal', function () {
  return {
    open: false,
    show: function show() {
      this.open = true;
...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].data('tabs', function () {
  var defaultTab = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  return {
...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].data('accordion', function () {
  return {
    openItems: [],
    toggle: function toggle(index) {
      if (this.openItems.includes(index)) {
        this.openItems = this.openItems.filter(function (i) {
          return i !== index;
        });
      } else {
...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].directive('tooltip', function (el, _ref, _ref2) {
...
window.showToast = function (message) {
  ...
  var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'success';
  var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3500;
  if ((_window$Alpine = window.Alpine) !== null && _window$Alpine !== void 0 && (_window$Alpine = _window$Alpine.store('app')) !== null && _window$Alpine !== void 0 && _window$Alpine.showToast) {
    alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app').showToast(message, type, duration);
  }
};
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.stat-card, .action-card, .glass-card').forEach(function (el) {
    observer.observe(el);
  });
...
window.axios.interceptors.response.use(function (response) {
  ...
  if (response.config.method !== 'get' && (_response$data = response.data) !== null && _response$data !== void 0 && _response$data.message) {
    setTimeout(function () {
      var _window$Alpine;
      if ((_window$Alpine = window.Alpine) !== null && _window$Alpine !== void 0 && (_window$Alpine = _window$Alpine.store('app')) !== null && _window$Alpine !== void 0 && _window$Alpine.showToast) {
        alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app').showToast(response.data.message, 'success');
      }
    }, 100);
  }
  return response;
}, function (error) {
  var _window$Alpine2, _window$Alpine3, _window$Alpine4, _error$response$data, _window$Alpine5, _window$Alpine6, _window$Alpine7;
  document.dispatchEvent(new CustomEvent('ajax:complete'));
  ...
  if (error.response) {
    switch (error.response.status) {
      ...
      case 403:
        // Forbidden
        if ((_window$Alpine2 = window.Alpine) !== null && _window$Alpine2 !== void 0 && (_window$Alpine2 = _window$Alpine2.store('app')) !== null && _window$Alpine2 !== void 0 && _window$Alpine2.showToast) {
          alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app').showToast('Accès non autorisé', 'error');
        }
        break;
      case 404:
        // Not Found
        if ((_window$Alpine3 = window.Alpine) !== null && _window$Alpine3 !== void 0 && (_window$Alpine3 = _window$Alpine3.store('app')) !== null && _window$Alpine3 !== void 0 && _window$Alpine3.showToast) {
          alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app').showToast('Ressource non trouvée', 'error');
        }
        break;
      case 419:
        // Session expired
        if ((_window$Alpine4 = window.Alpine) !== null && _window$Alpine4 !== void 0 && (_window$Alpine4 = _window$Alpine4.store('app')) !== null && _window$Alpine4 !== void 0 && _window$Alpine4.showToast) {
          alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app').showToast('Session expirée, veuillez vous reconnecter', 'error');
          setTimeout(function () {
      ...
      case 422:
        ...
        if ((_error$response$data = error.response.data) !== null && _error$response$data !== void 0 && _error$response$data.errors) {
          ...
          Object.keys(errors).forEach(function (key) {
            var input = document.querySelector("[name=\"".concat(key, "\"], [name=\"").concat(key, "[]\"]"));
            if (input) {
      ...
      case 429:
        // Too many requests
        if ((_window$Alpine5 = window.Alpine) !== null && _window$Alpine5 !== void 0 && (_window$Alpine5 = _window$Alpine5.store('app')) !== null && _window$Alpine5 !== void 0 && _window$Alpine5.showToast) {
          alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app').showToast('Trop de requêtes, veuillez patienter', 'error');
        }
        break;
      case 500:
        // Server error
        if ((_window$Alpine6 = window.Alpine) !== null && _window$Alpine6 !== void 0 && (_window$Alpine6 = _window$Alpine6.store('app')) !== null && _window$Alpine6 !== void 0 && _window$Alpine6.showToast) {
          alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app').showToast('Erreur serveur, veuillez réessayer plus tard', 'error');
        }
        break;
      default:
        if ((_window$Alpine7 = window.Alpine) !== null && _window$Alpine7 !== void 0 && (_window$Alpine7 = _window$Alpine7.store('app')) !== null && _window$Alpine7 !== void 0 && _window$Alpine7.showToast) {
          alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app').showToast('Une erreur est survenue', 'error');
        }
    }
  } else if (error.request) {
    var _window$Alpine8;
    // Network error
    if ((_window$Alpine8 = window.Alpine) !== null && _window$Alpine8 !== void 0 && (_window$Alpine8 = _window$Alpine8.store('app')) !== null && _window$Alpine8 !== void 0 && _window$Alpine8.showToast) {
      alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('app').showToast('Erreur réseau, vérifiez votre connexion', 'error');
    }
  }
  return Promise.reject(error);
});
